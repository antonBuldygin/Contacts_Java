class TestDrive {
    public static void main(String[] args) throws InterruptedException {
        BurgerStore mcDonalds = /* write your code here */new McDonStore();
        BurgerStore burgerKing = /* write your code here */new BurgerKingStore();
...
class McDonStore extends BurgerStore {
    ...
    protected Burger createBurger(String type) {
        Burger burger = null;
        BurgerIngredientFactory ingredientFactory = /* write your code here */new McDonIngredientFactory();

        switch (type) {
            case Burger.CHEESE :
                burger = /* write your code here */new Cheeseburger(ingredientFactory);
                burger.setName("McDonalds Style Cheeseburger");
                break;
            case Burger.VEGAN :
                burger = /* write your code here */new VeganBurger(ingredientFactory);
                burger.setName("McDonalds Style VeganBurger");
                break;
            default:
                burger = /* write your code here */new Hamburger(ingredientFactory);
