    ...
    public static void main(String[] args) {
        ...
        switch (string) {
            ...
            case "setOfConsonants":
                object.enumSet= EnumSet.complementOf(EnumSet.of(Alphabets.A,Alphabets.E,Alphabets.I,Alphabets.O,Alphabets.U));
                break;
            case "containsAOnly":
            ...
            case "empty":
                ...
                break;
            case "exceptT-A-E":
                object.enumSet= EnumSet.complementOf(EnumSet.of(Alphabets.A,Alphabets.E,Alphabets.T));
                break;
